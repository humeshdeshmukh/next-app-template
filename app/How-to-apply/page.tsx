...
<div className="max-w-full mx-auto p-8 grid grid-cols-1 lg:grid-cols-4 gap-8">
      ...
      >
        <h2 className="text-2xl font-semibold mb-6 text-blue-400">How to Apply</h2>
        <motion.ul
          className="space-y-4"
          variants={{
            hidden: { opacity: 0 },
      ...
      >
        ...
        >
          {(applicationSteps[selectedOption] || ['Details not available for this option.']).map((step, index) => (
            <motion.div
              key={index}
